...
void init_Data(Data **data, Config *param)
{
    ...
    (*data)->inun = malloc(param->n2ci*sizeof(double));
    ...
    (*data)->dss = malloc(param->n2ci*sizeof(double));
    (*data)->qdifz = malloc(param->n2ci*sizeof(double));
    ...
    if (param->n_scalar > 0)
    {
        ...
        (*data)->s_surfn = malloc(param->n_scalar*sizeof(double *));
        ...
        (*data)->sm_loss = malloc(2*sizeof(double));
        (*data)->sm_loss[0] = 0.0;
        (*data)->sm_loss[1] = 0.0;
        for (ii = 0; ii < param->n_scalar; ii++)
        {
            (*data)->s_surf[ii] = malloc(param->n2ct*sizeof(double));
            (*data)->s_surfn[ii] = malloc(param->n2ci*sizeof(double));
