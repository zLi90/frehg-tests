...
typedef struct Data
{
    ...
    // surface domain
    int *reset_seepage;
    double *uu, *un, *uy, *vv, *vn, *vx, *eta, *etan, *dept, *deptx, *depty, *qseepage, *qseepage_old, *qss, *rss, *dss, *qdifz;
    ...
    double *Vs, *Vsn, *Vflux, *Vsx, *Vsy, *Asx, *Asy, *Asz, *Aszx, *Aszy, *inun;
    ...
    // scalar
    double **s_surf, **sm_surf, **s_surf_root, **s_surf_out, **s_surfkP, **s_surfn;
